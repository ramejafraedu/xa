...
```
Clip 1 (Hook visual):     3.0s  ← impactante, establece tono
Clip 2 (Contexto):        4.5s  ← un poco más lento, info base
Clip 3 (Primer giro):     3.5s  ← corte rápido, sorpresa
Clip 4 (Desarrollo 1):    5.0s  ← respira, datos importantes
Clip 5 (Desarrollo 2):    4.0s  ← mantiene ritmo
Clip 6 (Escalada):        3.0s  ← acelera, tensión crece
Clip 7 (Revelación):      6.0s  ← el momento más importante, dar tiempo
Clip 8 (CTA/Cierre):      4.0s  ← punch final, memorable
Total:                   33.0s  ← ajustar proporcionalmente al audio
```
...
- Los cortes más importantes deben caer en los beats musicales
- Los momentos de revelación verbal deben coincidir con inicio de clip
- El silencio de medio segundo antes de una revelación aumenta impacto 40%
